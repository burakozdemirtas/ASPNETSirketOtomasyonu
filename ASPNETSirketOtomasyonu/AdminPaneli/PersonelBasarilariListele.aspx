                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SqlDataSource1" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" AllowSorting="True" PageSize="3">
                                ...
                                <Columns>
                                    ...
                                    <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="/AdminPaneli/PersonelBasariGuncelle.aspx?gelenid={0}" HeaderText="Güncelle" Text="Güncelle">
...
<%--    select pb.ID,p.Adi,p.Soyadi,pb.Basari,pb.Tarih from PersonelBasarilari pb inner join Personeller p on pb.PersonelID=p.ID--%>
</asp:Content>
