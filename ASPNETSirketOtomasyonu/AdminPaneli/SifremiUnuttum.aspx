...
<body style="background-color: #eaeaea;">
    <form id="form1" runat="server">
        <div class="container" style="width: 50%; background-color: white; margin-top: 90px; border-radius: 10px;">
            ...
            <div class="form-group">
                <asp:TextBox ID="txtEmail" CssClass="form-control" PlaceHolder="E-mail Adresiniz"  runat="server"></asp:TextBox>
            </div>


            <div class="form-group">
                <asp:Button ID="btnResetle" CssClass="btn btn-succes" runat="server" Text="Resetle" OnClick="btnResetle_Click" />
            </div>
